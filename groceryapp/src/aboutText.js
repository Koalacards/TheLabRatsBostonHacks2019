  ...
  return (
    <div>
      ...
      <p id='aboutUs'>
        ...
        SimpliShop, a platform which actively sweeps the web finding prices from
        a variety of Boston supermarkets and puts it all in one easy-to-navigate
        website. Simply type in the item you want, and you will be presented with
        a list of results from nearby companies so you can can find all the best deals!
      </p>
    </div>
  );
};
